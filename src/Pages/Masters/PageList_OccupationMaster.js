...
const PageList_OccupationMaster = (props) => {
  ...
  const modalTitle = "Occupation Master";
  const rtPage_Add = "/AddOccupation";
  const rtPage_Edit = "/EditOccupation";
  const API_URL = `${API_WEB_URLS.MASTER}/0/token/OccupationMaster`;
  ...
  return (
    <div className="page-content">
      <RCDisplayPage
        ...
        searchKey={searchKey}
        Isbreadcrumb={true}
        breadCrumbTitle={"Occupation Master"}
        breadcrumbItem={"Occupation Master"}
        obj={obj}
        isSearchBox={true}
        isSNo={false}
        isCheckBox={false}
...
export default PageList_OccupationMaster;