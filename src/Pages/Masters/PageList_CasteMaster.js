...
const PageList_CasteMaster = (props) => {
  ...
  const modalTitle = "Caste Master";
  const rtPage_Add = "/AddCaste";
  const rtPage_Edit = "/EditCaste";
  const API_URL = `${API_WEB_URLS.MASTER}/0/token/CasteMaster`;
  ...
  return (
    <div className="page-content">
      <RCDisplayPage
        ...
        searchKey={searchKey}
        Isbreadcrumb={true}
        breadCrumbTitle={"Caste Master"}
        breadcrumbItem={"Caste Master"}
        obj={obj}
        isSearchBox={true}
        isSNo={false}
        isCheckBox={false}
...
export default PageList_CasteMaster;