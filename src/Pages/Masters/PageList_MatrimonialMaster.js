...
const PageList_MatrimonialMaster = () => {
  const [gridData, setGridData] = useState([]);
  const [loading, setLoading] = useState(true);
  const dispatch = useDispatch();
  const navigate = useNavigate();

  const breadCrumbTitle = "Matrimonial Master";
  const breadcrumbItem = "Matrimonial Master";
  const rtPage_Add = "/AddMatrimonial";
  const rtPage_Edit = "/EditMatrimonial";
  const API_URL = API_WEB_URLS.MASTER + "/0/token/MatrimonialMaster";
...
export default PageList_MatrimonialMaster;
